...
<html>
  <head>
    ...
    <title>My JSP 'SetUpMasterProjectsPhases.jsp' starting page</title>
...
window.location="jsp/login.jsp"
  ...
  <body bgcolor="pink">
<center><h2><font face="Engravers MT">Master Project Phases</font></h2></center>
<hr color="red">
   <form action="SetUpMasterProjectPhases">
