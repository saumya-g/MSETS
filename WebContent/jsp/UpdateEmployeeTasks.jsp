...
<html>
  <head>
    ...
    <title>My JSP 'UpdateEmployeeTasks.jsp' starting page</title>
...
window.location="jsp/login.jsp"
   ...
   <center><h2>Update Employee Tasks</h2></center>
   <form action="UpdateEmployeeTasks">
...
<tr><td>PhaseTaskId</td><td><input type="text" name="phasetaskid" value="<%=request.getParameter("phasetaskid") %>" readonly="readonly"></td></tr>    
     ...
     <tr><td>ChargePerHour</td><td><input type="text" name="chargeperhour" value="<%=request.getParameter("chargeperhour") %>"></td></tr>
        <tr><td>MaxHours</td><td><input type="text" name="maxhours" value="<%=request.getParameter("maxhours") %>"></td></tr>
