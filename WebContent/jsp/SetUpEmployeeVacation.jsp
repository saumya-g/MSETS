...
<html>
  <head>
    ...
    <title>My JSP 'SetUpEmployeeVacation.jsp' starting page</title>
...
window.location="jsp/login.jsp"
  ...
  <body bgcolor="pink">
   <center><h2><font face="Engravers MT">Employee Vacation</font></h2></center>
   <hr color="red">
   <form action="SetUpEmployeeVacation">
   <table align="center" border="2">
    ...
    <%} %>
     ...
     <tr><td><font face="Arial Rounded MT Bold" size="2">VacationDetails</font></td><td><input type="text" name="vacationdetails"></td></tr>
