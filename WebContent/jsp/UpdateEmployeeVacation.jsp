...
<html>
  <head>
    ...
    <title>My JSP 'UpdateEmployeeVacation.jsp' starting page</title>
...
window.location="jsp/login.jsp"
 ...
 <body bgcolor="900bc054">
   <center><h2>.Employee Vacation</h2></center>
   <form action="UpdateEmployeeVacation">
   <table align="center" border="6" bgcolor="pink">
	...
	<tr><td>siteId</td><td><input type="text" name="siteid" value="<%=request.getParameter("siteid") %>"readonly="readonly"></td></tr>    
    	<tr><td>VacationDetails</td><td><input type="text" name="vacationdetails"  value="<%=request.getParameter("vacationdetails")%>"></td></tr>
