...
public class SetUpMasterOrganization extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try
		{
			...
			PreparedStatement ps = con.prepareStatement("insert into tblmasterorganization (orgName, addressDetails, contactDetails, status) values(?,?,?,?)");
