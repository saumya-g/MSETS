...
public class UpdateUser extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
	 ...
	 PreparedStatement ps=con.prepareStatement("update tblmasterusers set userType=?, firstName=?, lastName=?, phone=?, mobile=?, email=?, loginID=?, pwd=?, status=? where userid=?");
	 ...
	 if(i>0)
	 {
		 RequestDispatcher rd = request.getRequestDispatcher("jsp/ViewMasterUsers.jsp");
