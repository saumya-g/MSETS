...
public class SetUpSiteEmployees extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try
		{
			...
			PreparedStatement ps= con.prepareStatement("insert into tblsiteemployees (siteID, userID, disignation, startDate, status) values (?,?,?,?,?)");
			...
			int i= ps.executeUpdate();
			 if(i>0)
			 {
				 RequestDispatcher rd = request.getRequestDispatcher("jsp/SetUpSiteEmployees.jsp");
